...
As we can see above, the dataframe consists of 12 columns that consist of a numeric kind of data and two columns have characteristic data. In total the data set contains 615 observations.

The data set is distinguished by Category. So the health-state of the patients is viewed as Category. Down below is given that the majority of the data set consists of Blood Donors.
